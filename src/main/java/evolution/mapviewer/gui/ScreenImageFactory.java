...
public class ScreenImageFactory
{
    /*
        ...
        String fileName ) throws IOException
    {
        ...
        return ScreenImageFactory.createImage( component, region, fileName );
    }
        ...
        Rectangle region, String fileName ) throws IOException
    {
        ...
        ScreenImageFactory.writeImage( image, fileName );
        return image;
    }
        ...
        String fileName ) throws AWTException, IOException
    {
        ...
        region.x = p.x;
        region.y = p.y;
        return ScreenImageFactory.createImage( region, fileName );
    }
